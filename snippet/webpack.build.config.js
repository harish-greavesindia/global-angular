...
const genDirNodeModules = path.join(process.cwd(), 'snippet', '$$_gendir', 'node_modules');
...
module.exports = {
  ...
  "output": {
    "path": path.join(process.cwd(), "snippet/dist"),
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "snippet\\styles.css")
        ],
        "test": /\.css$/,
        "use": [
  ...
  "plugins": [
    ...
    new CopyWebpackPlugin([
      {
        ...
        "to": "",
        "from": {
          "glob": "C:\\Users\\it-su\\Projects\\Angular2\\global-angular\\snippet\\assets\\**\\*",
          "dot": true
        }
      },
      {
        ...
        "to": "",
        "from": {
          "glob": "C:\\Users\\it-su\\Projects\\Angular2\\global-angular\\snippet\\favicon.ico",
          "dot": true
        }
      }
    ], {
    ...
    new AngularCompilerPlugin({
      ...
      "sourceMap": true,
      "tsConfigPath": "snippet\\tsconfig.app.json",
      "compilerOptions": {}
    })
  ],
  "node": {
